...
export class AbsoluteAnchorer {
    static modify(elementRelatedStyle, computedStyle, commitParams, editingElement) {
    ...
    static applyForOnlyRight(elementRelatedStyle, computedStyle, commitParams, editingElement, inlineStlLeft) {
        if (!inlineStlLeft)
