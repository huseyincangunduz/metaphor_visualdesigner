...
export let ColorPicker : VueComponent = Vue.component("color-picker",
    {
        ...
        methods: {
            ...
            colorChange(h: number , s : number ,  v : number)  {
            ...
            selectorOnMsDown(e : MouseEvent) {
                this.selectorData.hold = true;
                this.selectorData.positions = { x: e.pageX, y: e.pageY };

            },
            selectorOnMsUp(e : MouseEvent) {
                this.selectorData.hold = false;
            },
            selectorMsMove(e : MouseEvent) {
                if (this.selectorData.hold) {
                    let sel : HTMLElement = this.$refs.selector;
                    let bck : HTMLElement = this.$refs.bck;
